...
/*   Updated: 2022/10/09 13:20:51 by mboukhal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cast_ray(t_cub *cub, float ray_angle, int stripl)
{
	...
	float horz_hit_distance = fod_hoz_wall_hit ? distanceBetweenPoints(
		cub->px, cub->py, horz_wall_hit_x, horz_wall_hit_y)
	: FLT_MAX;
	float vert_hit_distance = fod_vert_wall_hit ? distanceBetweenPoints(
		cub->px, cub->py, vert_wall_hit_x, vert_wall_hit_y)
	: FLT_MAX;
	if (vert_hit_distance < horz_hit_distance)
	{
		// draw_line(cub, cub->px, cub->py, next_vert_touch_x , next_vert_touch_y, 0xFFC0FF);
	...
	{
		// draw_line(cub, cub->px, cub->py, next_horz_touch_x , next_horz_touch_y, 0x00FFCC);
